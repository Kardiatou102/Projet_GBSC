...
- nbr_hab : variable quantitative discrète
...
\begin{center}\includegraphics[width=12cm]{rapport_GBSC_files/figure-latex/unnamed-chunk-15-1} \end{center}
...
\begin{center}\includegraphics[width=12cm]{rapport_GBSC_files/figure-latex/unnamed-chunk-18-1} \end{center}
\medskip
...
\begin{center}\includegraphics[width=12cm]{rapport_GBSC_files/figure-latex/unnamed-chunk-19-1} \end{center}
\medskip 
...
\begin{center}\includegraphics[width=12cm]{rapport_GBSC_files/figure-latex/unnamed-chunk-22-1} \end{center}
...
\begin{center}\includegraphics[width=12cm]{rapport_GBSC_files/figure-latex/unnamed-chunk-25-1} \end{center}
\medskip
...
{\centering \includegraphics[width=12cm]{rapport_GBSC_files/figure-latex/unnamed-chunk-29-1} 
...
**Lien de la vidéo du rapport**:
\tiny
\texttt{\url{https://pod.univ-montp3.fr/video/13808-video_projet_groupegbscmp4/}} 
...
\begin{center}\includegraphics[width=12cm]{rapport_GBSC_files/figure-latex/unnamed-chunk-30-1} \end{center}
